...
## [About this document](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API/Using_IndexedDB#about_this_document)

This tutorial walks you through using the asynchronous API of IndexedDB. If you are not familiar with IndexedDB, you should first read the [IndexedDB key characteristics and basic terminology](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API/Basic_Terminology) article.

For the reference documentation on the IndexedDB API, see the [IndexedDB API](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API) article and its subpages. This article documents the types of objects used by IndexedDB, as well as the methods of the asynchronous API (the synchronous API was removed from spec).

## [Basic pattern](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API/Using_IndexedDB#basic_pattern)
...
### [Adding data to the database](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API/Using_IndexedDB#adding_data_to_the_database)
...
### [Using an index](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API/Using_IndexedDB#using_an_index)
...
### [Specifying the range and direction of cursors](https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API/Using_IndexedDB#specifying_the_range_and_direction_of_cursors)
